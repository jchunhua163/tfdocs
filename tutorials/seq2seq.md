...
in the [RNN Tutorial](../tutorials/recurrent.md)
...
a GRU cell or an LSTM cell (see the [RNN Tutorial](../tutorials/recurrent.md)
...
See the [RNN Tutorial](../tutorials/recurrent.md) for examples.
...
[Vectors Representations Tutorial](../tutorials/word2vec.md) for more details
