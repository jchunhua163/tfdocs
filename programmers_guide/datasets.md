...
`Dataset.batch()`. See the documentation for [`tf.contrib.data.Dataset`](../api_docs/python/tf/contrib/data/Dataset.md)
...
[`tf.contrib.data.Iterator.from_string_handle`](../api_docs/python/tf/contrib/data/Iterator.md#from_string_handle) to define a feedable iterator
