...
We recommend using the [`shuffle`](../api_docs/python/tf/contrib/data/Dataset.md#shuffle)
and [`batch`](../api_docs/python/tf/contrib/data/Dataset.md#batch) methods of a
[`Dataset`](../api_docs/python/tf/contrib/data/Dataset.md) to acomplish this. However, if you'd prefer
