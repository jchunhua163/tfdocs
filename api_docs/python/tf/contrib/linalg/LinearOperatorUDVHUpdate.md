...
<meta itemprop="name" content="tf.contrib.linalg.LinearOperatorUDVHUpdate" />
...
Defined in [`tensorflow/contrib/linalg/python/ops/linear_operator_udvh_update.py`](https://www.tensorflow.org/code/tensorflow/contrib/linalg/python/ops/linear_operator_udvh_update.py).
