...
<meta itemprop="name" content="tf.contrib.linalg.LinearOperatorFullMatrix" />
...
Inherits From: [`LinearOperator`](../../../tf/contrib/linalg/LinearOperator.md)



Defined in [`tensorflow/contrib/linalg/python/ops/linear_operator_full_matrix.py`](https://www.tensorflow.org/code/tensorflow/contrib/linalg/python/ops/linear_operator_full_matrix.py).
