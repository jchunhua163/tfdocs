...
<meta itemprop="name" content="tf.contrib.keras.layers.BatchNormalization" />
...
Defined in [`tensorflow/contrib/keras/python/keras/layers/normalization.py`](https://www.tensorflow.org/code/tensorflow/contrib/keras/python/keras/layers/normalization.py).
