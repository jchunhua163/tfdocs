...
<meta itemprop="name" content="tf.contrib.keras.layers.LocallyConnected1D" />
...
Defined in [`tensorflow/contrib/keras/python/keras/layers/local.py`](https://www.tensorflow.org/code/tensorflow/contrib/keras/python/keras/layers/local.py).
