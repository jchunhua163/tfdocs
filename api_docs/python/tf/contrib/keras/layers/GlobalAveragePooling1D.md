...
<meta itemprop="name" content="tf.contrib.keras.layers.GlobalAveragePooling1D" />
...
Defined in [`tensorflow/contrib/keras/python/keras/layers/pooling.py`](https://www.tensorflow.org/code/tensorflow/contrib/keras/python/keras/layers/pooling.py).
