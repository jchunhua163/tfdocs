...
<meta itemprop="name" content="tf.contrib.keras.layers.TimeDistributed" />
...
Inherits From: [`Wrapper`](../../../../tf/contrib/keras/layers/Wrapper.md)



Defined in [`tensorflow/contrib/keras/python/keras/layers/wrappers.py`](https://www.tensorflow.org/code/tensorflow/contrib/keras/python/keras/layers/wrappers.py).
