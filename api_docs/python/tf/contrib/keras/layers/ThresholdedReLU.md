...
<meta itemprop="name" content="tf.contrib.keras.layers.ThresholdedReLU" />
...
Defined in [`tensorflow/contrib/keras/python/keras/layers/advanced_activations.py`](https://www.tensorflow.org/code/tensorflow/contrib/keras/python/keras/layers/advanced_activations.py).
