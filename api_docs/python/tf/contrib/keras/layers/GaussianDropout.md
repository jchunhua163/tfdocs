...
<meta itemprop="name" content="tf.contrib.keras.layers.GaussianDropout" />
...
Defined in [`tensorflow/contrib/keras/python/keras/layers/noise.py`](https://www.tensorflow.org/code/tensorflow/contrib/keras/python/keras/layers/noise.py).
